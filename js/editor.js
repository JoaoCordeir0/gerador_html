...
function bold(n){
    ...
    if(typeof n !=='string'){
        switch(n){
            ...
            break
            case 4: a.texto.value=`${valor.comeco} <h1>${valor.meio}</h1> ${valor.final}`
            break
            case 5: a.texto.value=`${valor.comeco}<ul><li>${valor.meio}</li></ul> ${valor.final}`
            break
            case 6: a.texto.value=`${valor.comeco} <a href="LINK">${valor.meio}</a> ${valor.final}`
            break
            case 7: a.texto.value=`${valor.comeco} <s>${valor.meio}</s> ${valor.final}`
            break
            case 8: a.texto.value=`${valor.comeco}<ol><li>${valor.meio}</li></ol> ${valor.final}`
            break
